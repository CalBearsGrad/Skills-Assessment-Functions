...
def append_to_list_two(list, **args):
...
append_to_list_two([1, 2, 3], 1)


def multiple_function(word, triple_tuple(word) triple_word_tuple = (word, word, word) print triple_word_tuple return triple_word_tuple)
    
    By_three = triple_tuple

    return word, " , ", By_three
    

multiple_function('Balloonicorn')
